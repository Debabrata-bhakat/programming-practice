...
BinaryTreeNode<int> *search(BinaryTreeNode<int> *root, int element){
    if(root==NULL) return NULL;
    if(root->data == element) return root;
    else if (root->data > element) return search(root->left, element);
...
int main(){
    ...
    cin >> element;
    bool ans;
    if(search(root, element) == NULL) ans = false;
    else ans = true;
    cout << ans << endl;
}
